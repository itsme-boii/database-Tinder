...
console.log("is conneced database",pool)
const app = express();
app.use(cors());
...
const uploadImageToAzure = async (file) => {
    try {
        ...
        return `https://${AZURE_STORAGE_ACCOUNT_NAME}.blob.core.windows.net/${AZURE_BLOB_STORAGE_CONTAINER_NAME}/${AZURE_BLOB_STORAGE_CONTAINER_NAME}/${newFilename}`;
    } catch (error) {
